...
const HomePage = ({ query, setQuery, handleSearch, loading, error, result }: {
  query: string;
    ...
    <div style={{
      ...
      {result && (
        <div style={{ 
          ...
          borderRadius: '18px', 
          boxShadow: '0 4px 24px rgba(0, 188, 212, 0.10)', 
          padding: '2rem', 
          border: '1.5px solid #00bcd4',
          position: 'relative'
        }}>
          ...
          <div style={{ 
            ...
            <div style={{
              ...
              <div style={{ marginBottom: '0.3rem', fontWeight: 500 }}>Prediction Error</div>
              <div style={{ fontSize: '1.5rem', fontWeight: 700 }}>${Math.abs(result.predicted_next_day_close - result.actual_last_close).toFixed(2)}</div>
            </div>
          </div>
          {/* Chart */}
          {result.historical && result.historical.length > 0 && (
            <div style={{ 
              ...
              <ResponsiveContainer width="100%" height={320}>
                <LineChart data={result.historical}>
          ...
          {result.summary && (
            <div style={{ 
              ...
              <div style={{ color: '#00bcd4', fontWeight: 600, marginBottom: '0.5rem' }}>AI Analysis:</div>
              {result.summary}
            </div>
          )}
        </div>
  ...
  <div style={{ maxWidth: 1000, margin: '0 auto', padding: '0 2rem' }}>
    <div style={{
      ...
      <p style={{ 
        ...
        We are passionate developers who created this AI-powered stock prediction platform 
        to help investors make informed decisions using cutting-edge machine learning technology.
      </p>
      ...
      <div style={{ 
        ...
        <div style={{
          ...
          <p style={{ fontSize: '1.1rem', lineHeight: '1.6' }}>
            Full-stack developer and AI enthusiast. Specializes in machine learning 
        ...
        <div style={{
          ...
          <p style={{ fontSize: '1.1rem', lineHeight: '1.6' }}>
            Machine learning engineer and data analyst. Expert in predictive modeling 
        ...
        <div style={{
          ...
          <p style={{ fontSize: '1.1rem', lineHeight: '1.6' }}>
            Frontend developer and UI/UX specialist. Creates beautiful, intuitive 
